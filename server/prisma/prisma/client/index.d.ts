...
export namespace Prisma {
  ...
  */
  ...
  export class Prisma__UserClient<T, Null = never> implements PrismaPromise<T> {
    ...
    participantingAt<T extends ParticipantFindManyArgs = {}>(args?: Subset<T, ParticipantFindManyArgs>): CheckSelect<T, PrismaPromise<Array<Participant>| Null>, PrismaPromise<Array<ParticipantGetPayload<T>>| Null>>;
